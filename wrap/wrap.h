...
#ifdef LIB_TAP_API_EXPORT
#define TAP_API_EXPORT __declspec(dllexport)
#else
#define TAP_API_EXPORT __declspec(dllimport)
#endif
#else
#define TAP_API_EXPORT
#endif
 ...
 * @ingroup G_Q_Login
 */
extern "C" TAP_API_EXPORT TAPIINT32 ITapQuoteAPI_SetAPINotify(ITapQuoteAPI *pITapQuoteAPI, ITapQuoteAPINotify *apiNotify);
/**
 ...
 * @ingroup G_Q_Login
 */
extern "C" TAP_API_EXPORT TAPIINT32 ITapQuoteAPI_SetHostAddress(ITapQuoteAPI *pITapQuoteAPI, const TAPICHAR *IP, TAPIUINT16 port);
/**
 ...
 * @ingroup G_Q_Login
 */
extern "C" TAP_API_EXPORT TAPIINT32 ITapQuoteAPI_Login(ITapQuoteAPI *pITapQuoteAPI, const TapAPIQuoteLoginAuth *loginAuth);
/**
 * @brief	断开和服务器的链路连接。
 ...
 */
extern "C" TAP_API_EXPORT TAPIINT32 ITapQuoteAPI_Disconnect(ITapQuoteAPI *pITapQuoteAPI);
/**
 * @brief 得到所有品种
 ...
 */
extern "C" TAP_API_EXPORT TAPIINT32 ITapQuoteAPI_QryCommodity(ITapQuoteAPI *pITapQuoteAPI, TAPIUINT32 *sessionID);
/**
 ...
 */
extern "C" TAP_API_EXPORT TAPIINT32 ITapQuoteAPI_QryContract(ITapQuoteAPI *pITapQuoteAPI, TAPIUINT32 *sessionID, const TapAPICommodity *qryReq);
/**
 * @brief	订阅指定合约的行情
 ...
 * @ingroup G_Q_Quote
 */
extern "C" TAP_API_EXPORT TAPIINT32 ITapQuoteAPI_SubscribeQuote(ITapQuoteAPI *pITapQuoteAPI, TAPIUINT32 *sessionID, const TapAPIContract *contract);
/**
 * @brief	退订指定合约的行情
 * @details	退订已经订阅的行情信息。
 * @param[out] sessionID 返回请求的会话ID；
 ...
 * @ingroup G_Q_Quote
 */
extern "C" TAP_API_EXPORT TAPIINT32 ITapQuoteAPI_UnSubscribeQuote(ITapQuoteAPI *pITapQuoteAPI, TAPIUINT32 *sessionID, const TapAPIContract *contract);
